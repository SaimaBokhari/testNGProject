...
public class Day21_DataProvider3 {
    /*
    In this class, we will get the data from Excel using Data Provider.
    The only difference between Data Provider class 2 and class 3 is the place
    where we get the data,
    In class 2, we receive data from the class itself. In this class, we get the
    ...
    public Object[][] customerData(){
        ...
        // Call ExcelUtils class
        ExcelUtils excelUtils = new ExcelUtils(path, sheetName);

        // Use 2D Array method from  the ExcelUtil methods to receive the data from the Excel
        Object [][] customersCredentials = excelUtils.getDataArrayWithoutFirstRow();
